...
public class RoomController : MonoBehaviour {
    ...
    void Awake() {
        ...
        if (_checkerTransform.Find("L") != null) { var c = Instantiate(_doorPrefab[3], _doorsTransform).GetComponent<DoorController>(); _doors.Add(new DoorChecker() { _checker = _checkerTransform.Find("L").GetComponent<Rigidbody2D>(), _door = c }); c._openedByDefault = true; c._doorType = DoorOpenType.AlwaysOpen; c._roomToShow2 = this; c.Initialize(); }
